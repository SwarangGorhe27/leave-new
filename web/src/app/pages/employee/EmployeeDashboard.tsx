    ...
    <PortalPage>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-3">
          <KpiCard icon={CheckCircle2} label="Present This Month" value="19 / 28" sub="Working days logged" tone="green" />
          <KpiCard icon={CalendarDays} label="Leave Balance" value="12 days" sub="Annual leave remaining" tone="purple" />
          <KpiCard icon={AlertCircle} label="Late Arrivals" value="2" sub="This month" tone="orange" />
          <MaskableKpiCard
            icon={Wallet}
      ...
      <section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          <div className="dashboard-widget lg:col-span-2">
            <WidgetHeader icon={TrendingUp} title="Weekly Hours" subtitle="Hours worked this week" tone="purple" />
          ...
          <div className="dashboard-widget flex flex-col min-h-0">
            <WidgetHeader icon={CalendarDays} title="What's Coming" subtitle="Events, holidays & birthdays" tone="green" />
